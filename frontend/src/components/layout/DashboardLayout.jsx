...
const DashboardLayout = () => {
    ...
    ...(user && user.isAdmin ? [{ name: 'Admin', path: '/admin', icon: <Icon className="h-5 w-5" path="M12 2l2.09 6.26L20 9l-4.5 3.26L16.18 19 12 16.27 7.82 19l1.68-6.74L5 9l5.91-.74L12 2z" />, count: null }] : []),
    ];
